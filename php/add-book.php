	...
	**/
	if (isset($_POST['book_title'])       &&
		...
		**/
		...
		$user_input = 'title='.$title.'&category_id='.$category.'&desc='.$description.'&author_id='.$author.'&price='.$price;
		    ...
		    **/
		    if ($file['status'] == "error") {
		        ...
		        **/
			    ...
			    $res  = $stmt->execute([$title, $author, $description, $category, $book_cover_URL, $price, $file_URL]);
